...
set_property PACKAGE_PIN G18 [get_ports {pwm_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_o[0]}]
set_property SLEW FAST [get_ports {pwm_o[0]}]
set_property PULLUP true [get_ports {pwm_o[0]}]

set_property PACKAGE_PIN H17 [get_ports {pwm_o1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_o1[0]}]
set_property SLEW FAST [get_ports {pwm_o1[0]}]
set_property PULLUP true [get_ports {pwm_o1[0]}]

set_property PACKAGE_PIN L17 [get_ports {indiceM_in[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {indiceM_in[3]}]
set_property PACKAGE_PIN L16 [get_ports {indiceM_in[2]}]
set_property PACKAGE_PIN L15 [get_ports {indiceM_in[1]}]
set_property PACKAGE_PIN L14 [get_ports {indiceM_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {indiceM_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {indiceM_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {indiceM_in[0]}]
set_property PACKAGE_PIN M15 [get_ports {selinphase_in[3]}]
set_property PACKAGE_PIN M14 [get_ports {selinphase_in[2]}]
set_property PACKAGE_PIN J16 [get_ports {selinphase_in[1]}]
set_property PACKAGE_PIN K16 [get_ports {selinphase_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {selinphase_in[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {selinphase_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {selinphase_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {selinphase_in[0]}]

set_property PACKAGE_PIN K18 [get_ports Sel]
